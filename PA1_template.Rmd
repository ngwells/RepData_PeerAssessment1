...
The mean number of total steps per day is `r format(stepmean,2)`.
The median number of total steps per day is `r format(stepmedian,2)`.
...
```
On average, the interval `r maxinterval` contains the the maximum number of steps.
...
```
The mean number of the imputed total steps per day is `r format(stepmean2,2)`.
The median number of the imputed total steps per day is `r format(stepmedian2,2)`.
...
The difference in the mean is `r diffmean`. 
The difference in the median is `r diffmed`.
